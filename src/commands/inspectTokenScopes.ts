 ...
 */
async function initOniguruma(context: vscode.ExtensionContext): Promise<void> {
 ...
 */
function createOnigScanner(patterns: string[]): oniguruma.OnigScanner {
 ...
 */
function createOnigString(s: string): oniguruma.OnigString {
